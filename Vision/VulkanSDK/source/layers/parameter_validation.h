...
const VkImageCreateFlags AllVkImageCreateFlagBits = VK_IMAGE_CREATE_SPARSE_BINDING_BIT|VK_IMAGE_CREATE_SPARSE_RESIDENCY_BIT|VK_IMAGE_CREATE_SPARSE_ALIASED_BIT|VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT|VK_IMAGE_CREATE_CUBE_COMPATIBLE_BIT|VK_IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT_KHR;
    ...
    const VkPresentInfoKHR*                     pPresentInfo)
{
    ...
    if (pPresentInfo != NULL)
    {
        ...
        skipCall |= validate_struct_pnext(report_data, "vkQueuePresentKHR", "pPresentInfo->pNext", "VkDisplayPresentInfoKHR", pPresentInfo->pNext, ARRAY_SIZE(allowedStructs), allowedStructs, GeneratedHeaderVersion);
    ...
    VkImageFormatProperties2KHR*                pImageFormatProperties)
{
    ...
    {
        skipCall |= validate_struct_pnext(report_data, "vkGetPhysicalDeviceImageFormatProperties2KHR", "pImageFormatInfo->pNext", NULL, pImageFormatInfo->pNext, 0, NULL, GeneratedHeaderVersion);
