...
*/
void LiftTracker::Process(cv::Mat& source0){
	//Step Blur0:
	//input
	...
	double filterContoursMaxHeight = 600.0;  // default Double
 ...
 */
cv::Mat* LiftTracker::GetBlurOutput(){
 ...
 */
cv::Mat* LiftTracker::GetHsvThresholdOutput(){
 ...
 */
cv::Mat* LiftTracker::GetCvErodeOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* LiftTracker::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* LiftTracker::GetFilterContoursOutput(){
	 ...
	 */
	void LiftTracker::blur(cv::Mat &input, BlurType &type, double doubleRadius, cv::Mat &output) {
	 ...
	 * @param output The image in which to store the output.
	 */
	void LiftTracker::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void LiftTracker::cvErode(cv::Mat &src, cv::Mat &kernel, cv::Point &anchor, double iterations, int borderType, cv::Scalar &borderValue, cv::Mat &dst) {
	 ...
	 */
	void LiftTracker::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
	 ...
	 */
	void LiftTracker::filterContours(std::vector<std::vector<cv::Point> > &inputContours, double minArea, double minPerimeter, double minWidth, double maxWidth, double minHeight, double maxHeight, double solidity[], double maxVertexCount, double minVertexCount, double minRatio, double maxRatio, std::vector<std::vector<cv::Point> > &output) {
